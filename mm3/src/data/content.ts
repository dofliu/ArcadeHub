...
export const MONSTERS: MonsterDef[] = [
  // ---- vermin / beasts ----
  { id: 'giant_rat',   name: '巨鼠',   nameEn: 'Giant Rat',   hp: 11,  ac: 2,  attack: 2,  dmg: [2, 5],   speed: 9,  xp: 16,  gold: [1, 6],    family: 'beast',    color: '#9a8c98', sprite: 'rat',     desc: '地城中常見的害獸。' },
  { id: 'cave_spider', name: '洞穴蜘蛛', nameEn: 'Cave Spider', hp: 22, ac: 5, attack: 5, dmg: [4, 8], speed: 13, xp: 48, gold: [3, 9], family: 'beast', inflicts: { status: 'poisoned', chance: 0.4, rounds: 4 }, color: '#4a4e69', sprite: 'spider', desc: '迅捷而致命，毒牙傷人。' },
  { id: 'dire_wolf',   name: '恐狼',   nameEn: 'Dire Wolf',   hp: 30,  ac: 5,  attack: 6,  dmg: [5, 11],  speed: 14, xp: 56,  gold: [2, 8],    family: 'beast',    color: '#6c757d', sprite: 'wolf',    desc: '成群獵食的巨狼。' },
  { id: 'giant_snake', name: '巨蟒',   nameEn: 'Giant Snake', hp: 40,  ac: 6,  attack: 7,  dmg: [6, 12],  speed: 11, xp: 76,  gold: [4, 12],   family: 'beast', inflicts: { status: 'poisoned', chance: 0.55, rounds: 5 }, color: '#52796f', sprite: 'snake', desc: '纏繞絞殺的毒蟒。' },
  // ---- humanoids ----
  { id: 'kobold',      name: '狗頭人', nameEn: 'Kobold',      hp: 15,  ac: 3,  attack: 3,  dmg: [3, 6],   speed: 11, xp: 24,  gold: [4, 10],   family: 'humanoid', color: '#bc6c25', sprite: 'kobold',  desc: '成群結隊的小怪。' },
  { id: 'goblin',      name: '哥布林', nameEn: 'Goblin',      hp: 20,  ac: 4,  attack: 4,  dmg: [4, 8],   speed: 10, xp: 36,  gold: [6, 14],   family: 'humanoid', color: '#588157', sprite: 'goblin',  desc: '兇悍的綠皮戰士。' },
  { id: 'orc',         name: '半獸人', nameEn: 'Orc',         hp: 42,  ac: 6,  attack: 7,  dmg: [7, 14],  speed: 9,  xp: 78,  gold: [12, 24],  family: 'humanoid', color: '#606c38', sprite: 'orc',     desc: '強壯的戰士。' },
  { id: 'bandit',      name: '強盜',   nameEn: 'Bandit',      hp: 34,  ac: 6,  attack: 7,  dmg: [6, 12],  speed: 12, xp: 70,  gold: [20, 50],  family: 'humanoid', color: '#7f4f24', sprite: 'bandit',  desc: '攔路打劫的亡命之徒。' },
  { id: 'ogre',        name: '食人魔', nameEn: 'Ogre',        hp: 90,  ac: 7,  attack: 9,  dmg: [11, 22], speed: 7,  xp: 175, gold: [25, 60],  family: 'humanoid', size: 'large', color: '#9c6644', sprite: 'ogre', desc: '揮舞巨棒的笨重巨人。' },
  { id: 'dark_acolyte',name: '黑暗祭司', nameEn: 'Dark Acolyte', hp: 36, ac: 5, attack: 5, dmg: [4, 9], speed: 11, xp: 95, gold: [18, 36], spellId: 'flame_arrow', family: 'humanoid', color: '#5a189a', sprite: 'mage', desc: '會施放法術的敵人。' },
  { id: 'sorceress',   name: '女巫',   nameEn: 'Sorceress',   hp: 52,  ac: 6,  attack: 5,  dmg: [4, 9],   speed: 13, xp: 165, gold: [40, 80],  gems: [0, 2], spellId: 'fireball', family: 'humanoid', color: '#9d4edd', sprite: 'mage', desc: '操縱烈焰的危險施法者。' },
  // ---- undead ----
  { id: 'skeleton',    name: '骷髏兵', nameEn: 'Skeleton',    hp: 28,  ac: 5,  attack: 5,  dmg: [5, 10],  speed: 8,  xp: 56,  gold: [8, 18],   family: 'undead', resist: { cold: 50, poison: 100 }, color: '#e0e1dd', sprite: 'skeleton', desc: '被喚醒的亡者骨兵。' },
  { id: 'zombie',      name: '殭屍',   nameEn: 'Zombie',      hp: 50,  ac: 4,  attack: 6,  dmg: [5, 13],  speed: 5,  xp: 70,  gold: [5, 12],   family: 'undead', resist: { cold: 50, poison: 100 }, inflicts: { status: 'diseased', chance: 0.35, rounds: -1 }, color: '#7f5539', sprite: 'zombie', desc: '緩慢但耐打的腐屍。' },
  { id: 'ghoul',       name: '食屍鬼', nameEn: 'Ghoul',       hp: 54,  ac: 6,  attack: 8,  dmg: [6, 13],  speed: 10, xp: 110, gold: [10, 25],  family: 'undead', resist: { cold: 50, poison: 100 }, inflicts: { status: 'paralyzed', chance: 0.3, rounds: 2 }, color: '#a3b18a', sprite: 'ghoul', desc: '麻痺利爪的不死掠食者。' },
  { id: 'wraith',      name: '幽魂',   nameEn: 'Wraith',      hp: 66,  ac: 8,  attack: 9,  dmg: [7, 14],  speed: 13, xp: 180, gold: [20, 45],  family: 'undead', resist: { cold: 75, poison: 100, electric: 30 }, spellId: 'frostbite', color: '#8d99ae', sprite: 'wraith', desc: '飄忽不定的怨靈。' },
  // ---- elemental / construct ----
  ...
  { id: 'lich_king',   name: '巫妖王', nameEn: 'Lich King',   hp: 520, ac: 11, attack: 12, dmg: [14, 28], speed: 12, xp: 1100, gold: [200, 350], gems: [3, 8], spellId: 'fireball', family: 'undead', resist: { cold: 50, electric: 30, poison: 100 }, boss: true, size: 'large', color: '#7c3aed', color2: '#4cc9f0', sprite: 'lich', desc: '泰拉地城深處的不死之主。' },
  { id: 'terra_guardian', name: '泰拉守護者', nameEn: 'Terra Guardian', hp: 780, ac: 12, attack: 13, dmg: [16, 32], speed: 13, xp: 2600, gold: [400, 700], gems: [8, 16], spellId: 'meteor', family: 'construct', resist: { fire: 40, cold: 40, electric: 40, holy: 20, poison: 100 }, boss: true, size: 'huge', color: '#e9c46a', color2: '#e76f51', sprite: 'guardian', desc: '守衛泰拉核心的遠古造物，群島命運的最終試煉。' },
];
...
export const MAPS: TileMap[] = [
  ...
  // ===== Sorpigal Dungeon =====
  {
    ...
    encounters: {
      ...
      '9,7': { monsters: [{ id: 'goblin', count: [2, 3] }] },
      '3,9': { monsters: [{ id: 'skeleton', count: [1, 2] }, { id: 'cave_spider', count: [1, 2] }] },
    },
    portals: {
      '10,1': { toMap: 'sorpigal_d2', to: { x: 1, y: 1, dir: 1 }, label: '向下的階梯' },
      '1,1':  { toMap: 'overworld', to: { x: 5, y: 5, dir: 2 }, label: '回到地表' },
    },
  },
  {
    id: 'sorpigal_d2',
  ...
  // ===== Cyclops Cave =====
  {
    ...
    portals: {
      '1,1': { toMap: 'overworld', to: { x: 16, y: 4, dir: 2 }, label: '離開洞窟' },
    },
  },
  // ===== Wildabar Crypt =====
  {
    ...
    start: { x: 1, y: 1, dir: 1 },
    doors: {
      '10,8': { locked: true, keyItem: 'iron_key', text: '一扇沉重的鐵製墓門。' },
    },
    chests: {
    ...
    encounters: {
      ...
      '7,9':  { monsters: [{ id: 'wyvern', count: [1, 1] }], once: true, boss: true },
    },
    portals: {
      '1,1':  { toMap: 'overworld', to: { x: 17, y: 11, dir: 0 }, label: '離開古墓' },
